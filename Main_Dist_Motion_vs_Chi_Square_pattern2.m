...
for t=1:T
    ...
    for n=0:Interval_v:V_num
        ...
        Dist_Sheet(2,cnt)=Dist_Sheet(2,cnt)+sum(sum(Chi_Maps(StartPix(1):StartPix(1)+Obj_Size(1)-1,StartPix(2)-round(Motion_x):StartPix(2)+Obj_Size(2)-1,cnt)))/T/Obj_Size(1)/((Motion_x)+1)/Obj_Size(2);
    end
end
...
save(['../csv/IEEE/20201127_Motion_vs_Chi_width40'],'Dist_Sheet')
