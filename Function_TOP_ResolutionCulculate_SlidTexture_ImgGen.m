function [Imgs,img_resion]=Function_TOP_ResolutionCulculate_SlidTexture_ImgGen(SIZE,Num,Obj_Back_Size,Obj_Target_Size,Mov_back,Mov_target,Back_color,Obj_color_back,Obj_color_target,txt)
...
[Imgs,img_resion]=Function_Module_ResolutionCulculate_SlidTexture_ImgGen(Imgs,Mov_target,Start_pix,Obj_height_target,Obj_width_target,Obj_color_target,txt);
