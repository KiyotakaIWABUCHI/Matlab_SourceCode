function [bitplane_MC,Estimation_x,Estimation_y]=Function_ME_MDMap(bitplanes,Range_x,Range_y,Range_scale,Range_rotation,O_obj_Array,LabeledMDMap,Select_Area,down_sample_rate)
