function [Psnr,Ssim,Img_ROI,GT_ROI]=Function_ROI_PSNR(Img,GT,ROI)
Img=double(uint8(Img));
GT=double(uint8(GT));
Img_ROI=Img(ROI(1):ROI(1)+ROI(3)-1,ROI(2):ROI(2)+ROI(4)-1);
GT_ROI=GT(ROI(1):ROI(1)+ROI(3)-1,ROI(2):ROI(2)+ROI(4)-1);
