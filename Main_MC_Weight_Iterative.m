...
Range_x=[-80 80 4]; %[start end] 刻み range_x=[-40 40 4]; dolfine car_bus bird /traffic[-52 52 4]
Range_y=[-0 0 4]; %range_y=[-20 20 4]; dolfin car_bus bird eagle -50 50 /traffic[-20 20 4]
...
imwrite(uint8(Imgs(:,:,1)),['../Images/Output/test/FirstFrameGroudTruth.png'])
imwrite(uint8(Imgs(:,:,n)),['../Images/Output/test/nth_FrameGroudTruth.png'])
imwrite(uint8(Imgs(:,:,end)),['../Images/Output/test/LastFrameGroudTruth.png'])
%%%%%%%%%%%%% Main St%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
