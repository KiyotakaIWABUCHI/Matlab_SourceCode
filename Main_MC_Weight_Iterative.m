...
for i=0:T_LOOP-1
    ...
    [bitplane_MC,Estimation_x,Estimation_y]=Function_ME_ROIHeatMap_ROTATE(bitplanes,Range_x,Range_y,Range_scale,Range_rotate,O_obj,Heat_map+0.01,down_sample_rate);
    %% ROI Map Update  
