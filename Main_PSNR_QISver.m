...
[PSNR_CIS_long,SSIM_CIS_long]=Function_ROI_PSNR(CIS_long,GT,ROI);
[PSNR_CIS_short,SSIM_CIS_short]=Function_ROI_PSNR(CIS_short,GT,ROI);
[PSNR_Avg,SSIM_Avg]=Function_ROI_PSNR(Avg,GT,ROI);
[PSNR_prop,SSIM_prop]=Function_ROI_PSNR(Ours,GT,ROI);
[PSNR_prop_Weight,SSIM_prop_Weight]=Function_ROI_PSNR(Ours_advence,GT,ROI);
[PSNR_prop_Weight_high,SSIM_prop_Weight_high]=Function_ROI_PSNR(Ours_advence_highth,GT,ROI);
[PSNR_prop_Weight_low,SSIM_prop_Weight_low]=Function_ROI_PSNR(Ours_advence_lowth,GT,ROI);
[PSNR_Objwise,SSIM_Objwise]=Function_ROI_PSNR(Objwise,GT,ROI);
[PSNR_Pixwise_small,SSIM_Pixwise_small]=Function_ROI_PSNR(Pixwise_small,GT,ROI);
[PSNR_Pixwise_large,SSIM_Pixwise_large]=Function_ROI_PSNR(Pixwise_large,GT,ROI);
...
% %% ファイル出力
Gain=1.1;
imwrite(uint8(CIS_long*Gain),['../MSrep/tex/',Obj,'/CIS_long.png'])
imwrite(uint8(CIS_short*Gain),['../MSrep/tex/',Obj,'/CIS_short.png'])
imwrite(uint8(bitplanes(:,:,size(bitplanes,3)/2)*255),['../MSrep/tex/',Obj,'/nth_bitplane.png'])
imwrite(uint8(GT*Gain),['../MSrep/tex/',Obj,'/nth_Frame.png'])
imwrite(uint8(GT_first*Gain),['../MSrep/tex/',Obj,'/FirstFrame.png'])
imwrite(uint8(GT_last*Gain),['../MSrep/tex/',Obj,'/LastFrame.png'])
imwrite(uint8(Avg*Gain),['../MSrep/tex/',Obj,'/Avg.png'])
imwrite(uint8(Ours*Gain),['../MSrep/tex/',Obj,'/Ours.png'])
imwrite(uint8(Ours_advence*Gain),['../MSrep/tex/',Obj,'/Ours_advance.png'])
imwrite(uint8(Ours_advence_lowth*Gain),['../MSrep/tex/',Obj,'/Ours_advance_lowth.png'])
imwrite(uint8(Ours_advence_highth*Gain),['../MSrep/tex/',Obj,'/Ours_advance_highth.png'])
imwrite(uint8(Objwise*Gain),['../MSrep/tex/',Obj,'/ObjWise.png'])
imwrite(uint8(Pixwise_small*Gain),['../MSrep/tex/',Obj,'/BlockWise_11x11.png'])
imwrite(uint8(Pixwise_large*Gain),['../MSrep/tex/',Obj,'/BlockWise_31x31.png'])
writetable(result_table,['../MSrep/tex/',Obj,'/Image_Quality.txt'])